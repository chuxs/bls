...
function initScrollAnimations() {
    ...
    const staggerContainers = document.querySelectorAll('.stream-grid, .clients-grid, .safety-points');
...
document.addEventListener('DOMContentLoaded', () => {
    const stats = document.querySelectorAll('.stat-number, .ops-number, .badge-number');
